...
body, button, input, select, table, textarea {font-size:12px;border:none;font-family:"suit",-apple-system, BlinkMacSystemFont, "Malgun Gothic", "맑은 고딕", helvetica, "Apple SD Gothic Neo", sans-serif}
